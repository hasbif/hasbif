        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="w-[90%] lg:w-[80%] grid lg:grid-cols-3 gap-y-4 gap-x-0 lg:gap-x-8 lg:gap-y-0 font-sour text-justify">
            <motion.div
              ...
              >
                <Image alt="graduation-cap" height={56} width={56} src={filePathParse("/graduation-cap.png")} />
              </motion.div>
              <div className="relative overflow-hidden p-4">
                <div className="absolute left-0 bottom-0 h-48 w-auto -rotate-12 opacity-10">
                  <Image
                    src={filePathParse("/uh-logo.png")}
                    alt="UH logo"
                    width={192}
                    height={192}
            ...
            <motion.div
              ...
              <div className="absolute -right-8 -bottom-2 h-32 w-auto opacity-5">
                <Image
                  src={filePathParse("/hacktiv8.png")}
                  alt="Decorative logo"
                  width={128}
                  height={128}
                  className="h-full w-auto"
              ...
              >
                <Image alt="mouse" height={48} width={48} src={filePathParse("/mouse.png")} />
              </motion.div>
              <div className="flex flex-col gap-4 relative z-10">
            ...
            <motion.div
              ...
              <motion.div className="absolute top-[-2%] right-[-2%] lg:top-[-2%] lg:right-[-4%]"
                ...
                transition={{ repeat: Infinity, repeatType: 'loop', duration: 2, ease: "easeInOut" }}
              >
                <Image alt="speaker" height={64} width={64} src={filePathParse("/speakers.png")} />
              </motion.div>
